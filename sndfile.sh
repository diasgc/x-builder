...
cfg='cm'
tls='python'
dep='libogg vorbis opus flac speex'
eta='78'
pkg='sndfile'
# -----------------------------------------
...
CFG="-DENABLE_PACKAGE_CONFIG=ON -DBUILD_TESTING=OFF \
  -DOGG_LIBRARY=$LIBSDIR/libogg/lib -DOGG_INCLUDE_DIR=$LIBSDIR/libogg/include \
  -DVorbis_Vorbis_LIBRARY=$LIBSDIR/vorbis/lib -DVorbis_Vorbis_INCLUDE_DIR=$LIBSDIR/vorbis/include \
  -DFLAC_LIBRARY=$LIBSDIR/flac/lib -DFLAC_INCLUDE_DIR=$LIBSDIR/flac/include \
  -DOPUS_LIBRARY=$LIBSDIR/opus/lib -DOPUS_INCLUDE_DIR=$LIBSDIR/opus/include \
  -DSPEEX_LIBRARY=$LIBSDIR/speex/lib -DSPEEX_INCLUDE_DIR=$LIBSDIR/speex/include"
CSH="-DBUILD_SHARED_LIBS=OFF"
CBN="-DBUILD_PROGRAMS=ON"
