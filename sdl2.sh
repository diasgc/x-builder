...
# sty='git'
vrs='2.0.16'
src="https://github.com/libsdl-org/SDL/archive/refs/tags/release-${vrs}.tar.gz"
sty='tgz'
cfg='cm'
eta='60'
cst1='-DSDL_STATIC=ON -DSDL_STATIC_PIC=ON'
...
case $arch in
    aarch64*|arm*) CFG="$CFG -DARMNEON=ON -DARMSIMD=ON -DMMX=OFF";;
esac
